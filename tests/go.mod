...
require (
	...
	github.com/cometbft/cometbft v1.0.0-rc1.0.20240805134408-314422469051
...
require (
	buf.build/gen/go/cometbft/cometbft/protocolbuffers/go v1.34.2-20240701160653-fedbb9acfd2f.2 // indirect; indigirect
